package b1u3m0nk3y13.necromancer.entities.ai;
...
{
    private final EntityConjuredSkeleton entity;
    ...
    public EntityAIRangedAttack(EntityConjuredSkeleton skeleton, double speedAmplifier, int delay, float maxDistance)
    {
