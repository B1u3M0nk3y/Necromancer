package b1u3m0nk3y13.necromancer.entities.models;
...
public class ModelConjuredSkeleton extends ModelZombie //ModelZombie
{

    public ModelConjuredSkeleton()
    {
        this(0.0F, false);
    }

    public ModelConjuredSkeleton(float modelSize, boolean flag)
    {
        super();
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float par2, float par3, float partialTickTime)
    {
        ...
        if (itemstack != null && itemstack.getItem() == Items.BOW && ((EntityConjuredSkeleton)entitylivingbaseIn).isSwingingArms())
        {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn)
    {
        ...
        EntityConjuredSkeleton entityskeleton = (EntityConjuredSkeleton)entityIn;
